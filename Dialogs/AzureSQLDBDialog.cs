...
namespace finminds.Dialogs
{
    ...
    {
        FinmindContext context;
        public FinmindContext Context { get { return context; } }
        ...
        private async Task<DialogTurnResult> FinalStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            if ((bool)stepContext.Result)
            {
                ...
                return await stepContext.ReplaceDialogAsync(InitialDialogId, 
                    new DialogOptions { StartAtStep = 1, UserChoice = (string)stepContext.Values["UserChoice"] }
                , cancellationToken);
            }
            else
            {
